    ...
    use(req, res, next) {
        ...
        res.end = function (...args) {
            ...
            if (memoryDelta > 1024 * 1024) {
                this.logger.warn(`High memory usage: ${Math.round(memoryDelta / 1024 / 1024)}MB`, 'Performance');
            }
            if (duration > 1000) {
                this.logger.warn(`Slow request: ${req.method} ${req.originalUrl} took ${duration}ms`, 'Performance');
            }
